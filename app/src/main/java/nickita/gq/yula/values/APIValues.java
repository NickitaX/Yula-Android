package nickita.gq.yula.values;
...
public class APIValues {
    ...
    public final static String ADD_USER = SERVER_ADDRESS+"/api/add_user";
    public final static String NUMBER_OF_USERS = SERVER_ADDRESS+"/api/test/user_count";
    public final static String GET_ALL_TAGS = SERVER_ADDRESS+"/api/tags";
